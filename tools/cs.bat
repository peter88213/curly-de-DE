rem @echo off
REM cs.bat
REM summary: Collects everything for a OOTyW_de-DE release
...
set _source=%_root%\
set _target=%_root%\build\OOTyW_de-DE_v%_release%
...
echo # OOTyW_de-DE - OOTyW language pack (de-DE) v%_release%>%_target%\README.txt
...
set _file=%_root%\oxt\OOTyW_de-DE-%_release%.oxt
set _dest=%_target%\program\
call :copyFile

set _file=%_root%\oxt\OOTyW_de-DE-A-%_release%.oxt
set _dest=%_target%\program\
call :copyFile

set _file=%_root%\oxt\OOTyW_de-DE-L-%_release%.oxt
set _dest=%_target%\program\
call :copyFile
